...
from eeg.jaw_clench_detector import JawClenchDetector  # adjust import if needed
# from project.jaw_clench_detector import JawClenchDetector
...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self, mode: int = 1):
        ...
        self.mode = mode  # 1 = blink, 2 = jaw clench
        ...
        # Blink mode calibration
        self.calibrating = self.mode == 1
        ...
        if self.mode == 1:
            ...
            self.label.setText("Jaw mode ready. Clench to jump.")
    ...
    def _setup_ui(self):
        ...
        self.plot = pg.PlotWidget(title="EEG (Fp3)")
    ...
    def update_loop(self):
        ...
        for v, t in zip(fp1, ts):
            ...
            if self.mode == 1 and self.calibrating:
